...
public class TestMain {
	...
	public void creatSubject() {
		...
		dance = new Subject("방송 댄스", Define.DNACE);
	...
	public void createStudent() {
		...
		Student student3 = new Student(181213, "이동호", korean);
		Student student4 = new Student(181213, "조성욱", korean);
		Student student5 = new Student(181213, "최태평", math);	
